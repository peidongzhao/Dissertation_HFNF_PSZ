...
fig_name_1 = 'a_01_StressField.png'
fig_name_2 = 'a_02_StressValidate.png'
...
c1 = ax1.pcolor(RE.x, RE.y, RE.sig11,cmap='RdBu',vmin=sig11_lower_bound,vmax=-25)
...
C2 = ax2.pcolor(RE.x, RE.y, RE.sig22, cmap='RdBu',vmin=sig22_lower_bound, 
                vmax=-15)
...
c3 = ax3.pcolor(RE.x, RE.y, RE.sig12, cmap='RdBu', vmin=-3, vmax=3)
...
fig.suptitle('S$_{hmax}$ = 30 MPa, S$_{hmin}$ = 25 MPa, P$_{net}$ = 3 MPa',
             y=1.03, fontsize=16);
plt.savefig(save_plots_to+fig_name_1, dpi=300,bbox_inches='tight')

##############################################################################
# __init__(self, length, S1, S2, P_net, delta, Lx, Ly):
RE = SingleFractureStress(4,30,25,3,0.001,20,0.004)
...
plt.title('Stresses Along the Hydraulic Fracture',fontsize=14,y=1.02)
...
plt.savefig(save_plots_to+fig_name_2, dpi=300)
